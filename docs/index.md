...
You can see the code in the `src` folder. The main file is [my_telegram_bot.py](my_telegram_bot.py). The other files are the handlers and the utils. The structure is the following:
- Main file: [my_telegram_bot.py](my_telegram_bot.md)
- Command handlers: [handlers.py](src/handlers.py)
- Message handlers: [message_handlers.py](src/message_handlers.py)
- Utils: [utils.py](src/utils.py)
